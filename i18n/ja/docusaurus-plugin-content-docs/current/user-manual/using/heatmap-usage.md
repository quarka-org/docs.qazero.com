...
![ヒートマップ](/img/heatmap/heatmap-1.png)
...
画面上部メニューバー  
![ヒートマップメニューバー](/img/heatmap/heatmap-2.png)
...
![クリックカウントマップ](/img/heatmap/heatmap-3.png)
...
* **Filter**: 参照元などでデータを絞り込めます。ボタンをクリックすると、絞り込みウィンドウがポップアップ表示されます。  
...
* **サイト変更の影響**: サイトページの内容（HTML）が変更されている場合、ヒートマップの表示内容が、実際のサイトページ内容と異なることがあります。  
  詳しくは [ヒートマップバージョンについて](./heatmap-versions) をご覧ください。
