...
マテリアルは **[`ai/materials.yaml`](../for-ai/materials.yaml)** に列挙されています。ここに無い名前は存在しません。
...
- **[Materials](../api/materials/)** — 実際のデータ面とサンプル表。
- **[AI Instructions](../for-ai/index.md)** — AI クライアント向けのルール集。
