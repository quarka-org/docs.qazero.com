...
[`ai/materials.yaml`](../../for-ai/materials.yaml) carries many more.
...
are documented in [`ai/materials.yaml`](../../for-ai/materials.yaml):
...
- **[`/query` reference](../2026-05-11/reference/query.md)** — how to actually
