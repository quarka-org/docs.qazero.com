...
IDs; the full schema in [`ai/materials.yaml`](../../for-ai/materials.yaml)
...
See [`ai/materials.yaml`](../../for-ai/materials.yaml) for the full list.
...
- **[`/query` reference](../2026-05-11/reference/query.md)**.
